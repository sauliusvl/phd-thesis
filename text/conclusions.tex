...
Remarkably the very abstract problem of finding the spectrum of local operators in a conformal field theory is equivalent to finding the spectrum of a very physical spin chain system.
...
Finally we touched up the ABJM theory which is another notorious integrable supersymmetric gauge theory with a string dual.
...
Obviously at the moment there are just wild speculations.
