...
\end{equation}
These are the action angle variables for the theory, roughly they measure the length of the cut and in the physical picture they correspond to the amplitude of the excitation. 
...
\beq
	p_i(x) \rightarrow p_i(x) + \delta^{ij} p_i(x)
\eeq
...
\beq
	\mathcal{E} = \frac{1}{2} \sum_{ij} (-1)^{F_{ij}} \oint \frac{dx}{2\pi i} \( \Omega^{ij}(x) \d_x \log \sin \frac{p_i - p_j}{2} \)
\eeq
...
\beq
	\delta^{ij}_n = \delta^{ij} p_k(x;y) \vert_{y=x_n^{ij}}
\eeq
