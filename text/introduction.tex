...
The supergravity approximation is valid when $\alpha' \ll R^2$ for low lying states, which corresponds to strongly coupled gauge theory, thus the conjecture is of the weak-strong type. 
...
Having in mind potential problems with the order of limits, it is thus naively possible to compare gauge theory calculations with string theory results.
