...
This result was then reformulated in the elegant language of algebraic curves by Kazakov, Marshakov, Minahan and Zarembo (KMMZ) \cite{Kazakov:2004qf}.
Comparisons in the first two orders of the BMN coupling constant $\lambda'$ showed promising agreement [??], however an order of limits problem emerged at three loops [??]. 
